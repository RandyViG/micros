...
Author  : 
Company : 
Comments: Utiliza el puerto B como entrada y escribe la información
	  en el puerto D, configurado como salida.
...
void iniPorts(){
    ...
    // State: Bit7=T Bit6=P Bit5=P Bit4=P Bit3=P Bit2=P Bit1=P Bit0=P 
